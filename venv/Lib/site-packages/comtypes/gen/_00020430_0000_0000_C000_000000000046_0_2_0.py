...
__all__ = [ 'Picture', 'OLE_CANCELBOOL', 'OLE_YPOS_CONTAINER',
           'IPicture', 'OLE_XSIZE_PIXELS', 'OLE_XPOS_CONTAINER',
           'OLE_HANDLE', 'Monochrome', 'FONTITALIC', 'IFontDisp',
           'Checked', 'Font', 'FONTSTRIKETHROUGH', 'Color',
           'OLE_COLOR', 'OLE_XPOS_HIMETRIC', 'Unchecked',
           'LoadPictureConstants', 'Default', 'IFont',
           ...
           'OLE_XPOS_PIXELS', 'FONTNAME', 'VgaColor', 'StdPicture',
           'StdFont', 'FontEvents', 'OLE_OPTEXCLUSIVE', 'FONTBOLD',
           'FONTUNDERSCORE', 'FONTSIZE', 'OLE_YSIZE_HIMETRIC',
